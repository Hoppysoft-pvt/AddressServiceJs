...
function _addressService() {
  _addressService = _asyncToGenerator(_regeneratorRuntime().mark(function _callee() {
    var searchText,
      _map,
      _map2,
      trimmedString,
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          searchText = _args.length > 0 && _args[0] !== undefined ? _args[0] : "";
          _map = (searchText.trim().match(/^(\S+)(?:\s(.+))?$/) || []).map(function (str) {
            return str || '';
          ...
          _context.prev = 9;
          _context.next = 12;
          return fetch('https://1e2tq2.hoppysearch.com/v1/search', requestOptions);
        case 12:
          res = _context.sent;
          _context.next = 15;
          return res.json();
        ...
        case 23:
          ...
          break;
        case 25:
          return _context.abrupt("return", "Please provide a valid searchText");
        case 26:
        case "end":
